...
const TRANSLATIONS = {
  ko: {
    ...
    pages: {
      ...
      button: {
        ...
        badge: "Action",
        description:
          "버튼은 사용자 액션을 트리거하는 핵심 인터랙션 컴포넌트입니다. 계층, 크기, 강조 수준에 따라 변형을 선택합니다.",
        size: "크기 조정하기",
        sizeDesc: "size 속성으로 Small, Medium, Large를 지정합니다.",
        hierarchy: "계층",
        accessibility: "접근성",
      },
      checkbox: {
  ...
  en: {
    ...
    home: {
      ...
      stats: [
        { label: "Design Tokens", value: "120+", desc: "Primitive · Semantic · Component" },
        { label: "Components", value: "7", desc: "Documented UI components" },
    ...
    pages: {
      ...
      button: {
        title: "Button",
        badge: "Action",
        description: "Core interaction component. Choose variants by hierarchy, size, and emphasis.",
        size: "Sizing",
        sizeDesc: "Set Small, Medium, Large via the size prop.",
        hierarchy: "Hierarchy",
  ...
  ja: {
    ...
    home: {
      ...
      stats: [
        { label: "Design Tokens", value: "120+", desc: "Primitive · Semantic · Component" },
        { label: "Components", value: "7", desc: "ドキュメント化されたUIコンポーネント" },
    ...
    pages: {
      ...
      button: {
        title: "Button",
        badge: "Action",
        description: "ユーザーアクションをトリガーする核心インタラクションコンポーネント。階層・サイズ・強調度で変種を選択。",
        size: "サイズ調整",
        sizeDesc: "size属性でSmall, Medium, Largeを指定。",
        hierarchy: "階層",
...
const NAV_STRUCTURE = [
  ...
  },
  {
    id: "components",
    key: "components",
    items: ["button", "checkbox", "accordion", "badge", "filter", "tab", "topappbar"],
  },
